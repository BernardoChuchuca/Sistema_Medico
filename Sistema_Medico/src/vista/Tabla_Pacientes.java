...
public class Tabla_Pacientes extends AbstractTableModel {

	public String[] columnas = {"id","Cedula","Nombre","Apellido","Correo","Direccion","Telefono","Genero"};//array de las columnas con el titulo del contenido
	public Class[] columnasTipos = {Integer.class, String.class,String.class,String.class,String.class,String.class,String.class,String.class};//tipo de dato a trbajar
	 ...
	 * @param datos
	 */
	public Tabla_Pacientes(ArrayList<Persona> datos) {
		super();
	...
	public void setValueAt(Object value, int row, int col) {
		...
		case 6:
			...
			break;   
                ...
                case 7:
			emp.setPer_genero((String) value);
			break; 
		}
	}
