...
public class Tabla_Empleados extends AbstractTableModel {
	...
	public String[] columnas = {"id","Cedula","Nombre","Apellido","Correo","Cargo","Genero","Clave","Direccion","Telefono","Fecha_Nacimiento"};//array de las columnas con el titulo del contenido
	...
	public void setValueAt(Object value, int row, int col) {
		...
		case 3:
			...
			break;
                case 5:
			emp.setPer_rol((String) value);
			break;        
		case 6:
			emp.setPer_genero((String) value);
			break; 
                case 7:
			emp.setPer_clave((String) value);
			break;
                case 8:
	...
	public Object getValueAt(int row, int col) {
		...
		case 3:
			...
			return emp.getPer_email();        
                case 5:
			return emp.getPer_rol();
		case 6:
			return emp.getPer_genero();
                case 7:
			return emp.getPer_clave();
		case 8:
